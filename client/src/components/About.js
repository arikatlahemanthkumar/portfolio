    ...
    <section id="about" className="py-12 sm:py-16 md:py-20 bg-gray-50">
      <div className="container-custom px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          >
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-4 sm:mb-6">Personal Info</h3>
            ...
            <div className="mt-6 sm:mt-8">
              <h4 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Education</h4>
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
                <h5 className="font-semibold text-primary-600 text-base sm:text-lg">{personalInfo.degree}</h5>
                <p className="text-gray-700 font-medium text-sm sm:text-base">{personalInfo.university}</p>
                <p className="text-gray-600 text-sm sm:text-base">{personalInfo.graduation}</p>
                <div className="mt-2 sm:mt-3">
                  <span className="inline-block bg-primary-100 text-primary-800 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium">
                    CGPA: 8.16
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {highlights.map((highlight, index) => (
                  <motion.div
                    ...
                    className="flex items-center space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
                  >
